...
from mcp.client.streamable_http import streamable_http_client   #warning streamablehttp_client is obsolete
...
Available agents:
- Rules Agent (http://127.0.0.1:8l000) - For D&D mechanics and rules
...
try:
    ...
    with mcp_client:
        ...
        agent = Agent(
            ...
            tools=mcp_tools + provider.tools
        )
